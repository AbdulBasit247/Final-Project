...
const OrderConfirmationPage = () => {
    ...
    return (
        <div className='max-w-4xl font-bold mx-auto text-center p-6 bg-white'>
            <h1 className='text-3xl font-bold text-emerald-700'>Thank you for Your Order!</h1>
                    ...
                    <div className='mb-20'>
                        ...
                        {checkout.checkoutItems.map((item) => (
                            ...
                            <div key={item.productId} className='flex items-center mb-4'>
                                ...
                                <div>
                                    <h4 className='font-semibold text-medium'>{item.name}</h4>
